...
$aluno_id = $_SESSION['professor_id'];
...
$foto_aluno = !empty($aluno['foto']) 
    ? "../img/fotos_professores/" . $aluno['foto'] 
    : "../img/fotos_professores/padrao.png";
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
<body>
    ...
    <div class="content">
        ...
        <input type="hidden" id="aluno_id" value="<?php echo $professor_id; ?>">
