...
if (!isset($_POST['aluno_id']) || !isset($_POST['data']) || !isset($_POST['titulo']) || !isset($_POST['tipo']) || !isset($_POST['descricao'])) {
    echo json_encode(['status' => 'error', 'message' => 'Dados incompletos.']);<?php
session_start();
include '../conexao.php'; // Caminho para o seu arquivo de conexão
